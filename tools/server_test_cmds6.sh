...
set -u
sleep "${1:-50}"
echo "execute in minecraft:the_end run forceload add 62 17"
echo "execute in minecraft:the_end run forceload add 65 17"
echo "execute in minecraft:the_end run forceload add 60 15"
echo "execute in minecraft:the_end run forceload add 65 20"
echo "execute in minecraft:the_end run forceload add -48 -43"
echo "execute in minecraft:the_end run forceload add -50 -45"
echo "execute in minecraft:the_end run forceload add -46 -41"
echo "execute in minecraft:the_end run forceload add -50 -41"
echo "execute in minecraft:the_end run forceload add 43 -54"
echo "execute in minecraft:the_end run forceload add 45 -54"
echo "execute in minecraft:the_end run forceload add 41 -52"
sleep 10
