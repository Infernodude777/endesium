...
/**
 * A dark, faintly translucent void glass. It lets the pale void light
 * through while keeping the deep mineral tint, so it reads as a window
 * into the void rather than a bright pane.
 */
