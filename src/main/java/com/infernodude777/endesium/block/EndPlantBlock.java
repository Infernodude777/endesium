...
/**
 * A low decorative End plant. It shares BushBlock's cross-model behavior and
 * can root on vanilla End stone, chorus growth, and every Endesium ground
 * block registered in {@link ModBlocks#isPlantGround}.
 */
