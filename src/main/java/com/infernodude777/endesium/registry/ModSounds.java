...
/**
 * Registry for all Endesium sound events: biome ambience, item/entity
 * sounds, and dragon fight effects.
 */
public final class ModSounds {
    ...
    public static final SoundEvent SHATTERED_HIGHLANDS_AMBIENT =
            register("ambient.shattered_highlands_low");
    public static final SoundEvent VOID_MARSHES_AMBIENT = register("ambient.void_marshes_low");
    public static final SoundEvent LUMINOUS_GROVES_AMBIENT =
            register("ambient.luminous_groves_low");
    public static final SoundEvent ASHEN_EXPANSE_AMBIENT = register("ambient.ashen_expanse_low");
    public static final SoundEvent CRYSTAL_BARRENS_AMBIENT =
            register("ambient.crystal_barrens_low");
    ...
    // --- Item sounds ---
    public static final SoundEvent RESONANCE_LENS_ACTIVATE =
            register("item.resonance_lens.activate");
    public static final SoundEvent RESONANCE_LENS_PULSE_LOW =
            register("item.resonance_lens.pulse_low");
    public static final SoundEvent RESONANCE_LENS_PULSE_HIGH =
            register("item.resonance_lens.pulse_high");
    public static final SoundEvent ECHO_COMPASS_USE = register("item.echo_compass.use");

    // --- Dragon and event sounds ---
    public static final SoundEvent DRAGON_TRANSFORMATION = register("event.dragon_transformation");
    public static final SoundEvent RUIN_MECHANISM_ACTIVATE =
            register("block.end_ruin_mechanism.activate");
    ...
    public static final SoundEvent VOID_STALKER_REPOSITION =
            register("entity.void_stalker.reposition");
    ...
    public static final SoundEvent CRYSTAL_BURROWER_IDLE =
            register("entity.crystal_burrower.idle");
    public static final SoundEvent CRYSTAL_BURROWER_HURT =
            register("entity.crystal_burrower.hurt");
    public static final SoundEvent CRYSTAL_BURROWER_DEATH =
            register("entity.crystal_burrower.death");
    public static final SoundEvent CRYSTAL_BURROWER_ATTACK =
            register("entity.crystal_burrower.attack");
