...
/**
 * The Void tool tier. Sits between diamond and netherite: fast, tough,
 * and highly enchantable, but not a band-aid that invalidates vanilla gear.
 * Repairs with Void Ingots.
 */
public enum VoidToolMaterial implements Tier {
    ...
    @Override
    public net.minecraft.tags.TagKey<net.minecraft.world.level.block.Block>
